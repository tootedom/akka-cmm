...
import akka.util.{ConcurrentMultiMap2}
...
object MainSynchronizedRemoveAndAdd {
  def main(args: Array[String]) {
    val loops = 1000
    val cmm = new ConcurrentMultiMap2[String, Int](1,
      new Comparator[Int] {
    ...
    class Producer(map: ConcurrentMultiMap2[String,Int]) extends Runnable {
    ...
    class Consumer(map: ConcurrentMultiMap2[String,Int]) extends Runnable {
