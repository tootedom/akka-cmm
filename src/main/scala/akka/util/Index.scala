 ...
 */
class Index2[K, V](val mapSize: Int, val valueComparator: Comparator[V]) {
 ...
 * Reads are fully concurrent <-- el-cheapo
 */
class ConcurrentMultiMap2[K, V](mapSize: Int, valueComparator: Comparator[V]) extends Index2[K, V](mapSize, valueComparator)
